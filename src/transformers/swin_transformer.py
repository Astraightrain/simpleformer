...
class PreNorm(nn.Module):
    ...
    def __init__(self, dim_emb, layer):
        super().__init()
        self.layer = layer
...
class CycleShift(nn.Module):
    ...
    def forward(self, x):
        return torch.roll(x, shifts=(self.shift, self.shift), dims = (1, 2)) # x, y rolling 
...
class WindowAttention(nn.Module):
    ...
    def __init__(
        ...
        self.dim_head = dim_in // nheads
        assert dim_in == self.dim_head * nheads 
